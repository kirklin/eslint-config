/**
 * Generated by tsnapi — public API snapshot of `@kirklin/eslint-config`
 */
// #region Interfaces
...
export declare function kirklin(_?: OptionsConfig & Omit<TypedFlatConfigItem, "files" | "ignores">, ..._: Awaitable<TypedFlatConfigItem | TypedFlatConfigItem[] | FlatConfigComposer<any, any> | Linter.Config[]>[]): FlatConfigComposer<TypedFlatConfigItem, ConfigNames>;
